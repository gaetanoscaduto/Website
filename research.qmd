...
At the age of 18, I moved to Turin, where I earned a Bachelor's degree in **Mathematics for Engineering** with top marks at the Polytechnic of Turin.
...
But then I grew tired of doing maths for its own sake. I enrolled in a Master's degree in **Political and Public Communication** at the University of Turin, from which I graduated in 2022.
...
Since February 2024, I have been living in Antwerp (Belgium), working with the "[Media, Movement, and Politics (M2P)](https://www.uantwerpen.be/en/research-groups/m2p/)". It started as a research stay, but it became my life, and now I'm based in Antwerp until further notice.

![The entrance to the Antwerp train station, one of its most famous landmarks](images/clipboard-3574034271.png){width="323"}

From October 2025, I will be starting a new adventure at the [Erasmus Institute on Culture and Stratification](https://www.eur.nl/essb/informatie-voor/onderzoekers/erasmus-institute-culture-and-stratification) within Erasmus University Rotterdam (EUR). There, I will be working on a project called "Understanding the different meanings of climate change among the public". The new challenges that I will face include using qualitative methods, exploring a new research field, and joining a new research community. I really look forward to it!

![The view of Rotterdam from EUR](images/rotterdam.jpeg){width="323"}


In my free time, I still love **writing** and **learning languages**. I am currently learning **Dutch**, which helps me integrate more easily into Belgian society. After that, I plan to refresh my French as well. I also love **biking** and listening to music of every genre. My all-time favorites? The Cure, Fabrizio De André, and Elio e le Storie Tese. My favorite directors are Paolo Sorrentino and Wes Anderson (but I swear I'm not *that* kind of hipster). My favorite TV show is probably *Scrubs* because it remains the only comedy series I still find amusing more than 20 years after its release. I am a huge fan of stand-up comedy.
:::
